...
_TABLES = [
    ...
    # 1. Parent Chunks（用于 Auto-merging Retriever）
    """
    ...
    """,
    "CREATE INDEX IF NOT EXISTS idx_parent_chunks_filename ON parent_chunks(filename);",
    ...
    # knowledge_file 补列：文件哈希
    "ALTER TABLE knowledge_file ADD COLUMN IF NOT EXISTS file_hash TEXT",
